...
from olam.generation.generator import _GEN_SOURCE_FILES
from olam.assembly import build_game_program
from olam.generation import (
    DRIVER_INPUT_SLOTS,
    GENERATION_PROGRAMS,
    generation_fingerprint,
    generation_identity,
)
from olam.modules.weather.engine_inputs import BASELINE_IDS
...
class TestDeclaration:
    ...
    def test_inventory_covers_fingerprint_sources(self):
        ...
        legacy_files = set(_GEN_SOURCE_FILES)
        declared_names = {rel.rsplit("/", 1)[-1] for rel in declared_files}
        missing_files = legacy_files - declared_names
    ...
    def test_source_files_exist(self):
        from olam.generation import BACKEND_ROOT
...
class TestDeterminism:
    ...
    def test_weather_field_sample_order_independent(self):
        from olam.generation.weather_field.field import CH_TEMPERATURE, UnifiedWeatherField
