...
from miskhak.save import STATE_VERSION
...
def _patch_fast_worldgen(monkeypatch):
    ...
    monkeypatch.setattr(
        "olam.generation.generator.WorldGenerator.ensure_continent",
        _fast_continent,
    )
...
class TestGameEngine:
    ...
    def test_engine_accepts_connection(self):
        ...
        import socket
        from testbench.integration.test_net import send_frame, recv_frame, handshake
...
class TestWorldProcessEntry:
    ...
    def test_full_state_round_trip_through_disk(self, monkeypatch):
        ...
        monkeypatch.setattr("miskhak.app.INITIAL_CHUNK_RADIUS", 1)
        monkeypatch.setattr(
...
class TestPeriodicSaveEndToEnd:
    ...
    def _publish_chain(self):
        ...
        from miskhak.events import world_tree, Event, AffectedParty
    ...
    def test_snapshot_contains_recent_events(self, monkeypatch):
        ...
        from miskhak.save import SaveManager
        from miskhak.events import world_tree, Event, AffectedParty
        from miskhak.events.archive import EventArchive
    ...
    def test_loaded_chunks_persist_across_restart(self, monkeypatch):
        ...
        from olam.content.chunk import ChunkData
...
class TestTerrainStatePersistence:
    ...
    def _patch_single_chunk(self, monkeypatch):
        ...
        """
        from miskhak.app import GameEngine as GE
        monkeypatch.setattr("miskhak.app.INITIAL_CHUNK_RADIUS", 0)
        monkeypatch.setattr(
