...
Coverage: olam.content.loader.load_content + terrain._build_terrain_defs/_parse_*。
"""
...
from olam.content.loader import DATA_DIR, load_content
from olam.generation.terrain import (
    TERRAIN_DEFS,
    TerrainType,
    get_terrain_def,
    terrain_by_id,
...
from olam.content.state_defs import STATE_TYPES
...
class TestDataFile:
    ...
    def test_bad_json_rejected(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr("olam.content.loader.DATA_DIR", tmp_path)
...
class TestContractValidation:
    ...
    def test_unknown_state_in_parse(self):
        ...
        from olam.generation.terrain import state_params
