...
覆盖 miskhak/net/handlers/save_handler.py。
"""
...
from miskhak.save.manager import SaveManager
from miskhak.save.manifest import SEED_MAX
...
class TestSaveCreate:
    ...
    def test_create_land_ratio_out_of_range_rejected(self, handlers):
        ...
        from miskhak.save.manifest import SaveFormatError
