...
class TestVisualOutput:
    ...
    用法:
        .venv/bin/python -m pytest testbench/unit/test_continent.py::TestVisualOutput -v -s
    """

    # 输出目录：miskhak/tools/visual/output（已在 .gitignore）
    _OUTPUT_DIR = os.path.join(
        os.path.dirname(__file__), "..", "..",
        "miskhak", "tools", "visual", "output",
    )

    def test_visual_01_outline(self):
        """步骤1：大陆轮廓 → visual/output/01_continent_outline.png"""
        from olam.generation.continent import ContinentData
        from miskhak.tools.visual.render import render_mask
    ...
    def test_visual_02_elevation(self):
        ...
        from olam.generation.continent import ContinentData
        from miskhak.tools.visual.render import render_elevation
    ...
    def test_visual_03_temperature(self):
        ...
        from olam.generation.continent import ContinentData
        from miskhak.tools.visual.render import render_temperature
    ...
    def test_visual_04_rainfall(self):
        ...
        from olam.generation.continent import ContinentData
        from miskhak.tools.visual.render import render_rainfall
    ...
    def test_visual_05_climate(self):
        ...
        from olam.generation.continent import ContinentData
        from miskhak.tools.visual.render import render_blocks
    ...
    def test_visual_06_water_bodies(self):
        ...
        from olam.generation.continent import ContinentData
        from miskhak.tools.visual.render import render_elevation_with_rivers, render_overlay_lines
...
def _render_elevation_with_lines(
    ...
    *,
    ...
    from miskhak.tools.visual.render import _elevation_to_rgb
