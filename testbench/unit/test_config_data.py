...
Coverage: olam.constants._apply_content/_coerce_content + load_content("world")。
"""

import pytest

from olam.content.loader import load_content
from olam import constants as c
from olam.constants import _apply_content, _coerce_content
...
class TestWorldDataFile:
    ...
    def test_infra_constants_untouched(self):
        """基础设施常量不受数据文件影响。"""
        from miskhak import config as g

        assert g.SERVER_PORT == 9081
