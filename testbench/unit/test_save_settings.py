...
覆盖 miskhak/save/settings.py：声明一致放行、未记录放行（由调用方补写）、
...
from miskhak.save.manifest import Manifest, SaveFormatError
from miskhak.save.settings import validate_world_program, validate_world_settings
