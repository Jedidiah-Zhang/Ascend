...
- [研究综述](docs/研究理论/研究综述.md) — 统一定义、符号与三阶段研究计划
- [研究理论 · 世界基座](docs/研究理论/世界基座/) — 因果世界规范、数学附件与实现验收（第一阶段）
- [研究理论 · 反事实与认知](docs/研究理论/反事实与认知/) — 可识别性、干预采样与因果能力评价（第二阶段）
- [研究理论 · 多智能体](docs/研究理论/多智能体/) — 联合干预、策略响应与宏观结构（第三阶段）
