...
def build_manifest() -> dict:
    ...
    from ascend.world.kernel import TABLE_DIGEST
    from ascend.world.meta.validate import kernel_digest
...
def _mutation_observe_unquantized() -> tuple[object, object]:
    ...
    from ascend.world.research import observation
...
def _mutation_record_unchecked() -> tuple[object, object]:
    ...
    from ascend.world.research.records import TraceLog
...
def _mutation_address_order() -> tuple[object, object]:
    ...
    from ascend.world.meta import context
