...
└── AscendLean/
    └── CausalVerification/          # ← 对应 docs/研究理论/世界基座/（命题 2.5 等）
        ├── ChainError.lean          # 命题 2.1 链式误差传播闭式（试点）
        ├── Contraction.lean         # 推论 2.2 三档行为 + 推论 2.3 收缩链两律（外推饱和/初值遗忘）
        ├── DagPathExpansion.lean    # 命题 2.5 代数内核：递推 ⟹ 路径和展开 + 汇聚反例
        ├── LipschitzLayer.lean      # 连接命题：|Xh − X| ≤ e_t，组合出命题 2.5 完整式
...
| 来源                                                                | 形式化文件              | 内容                                                                                  |
| ------------------------------------------------------------------- | ----------------------- | ------------------------------------------------------------------------------------- |
| 02-误差传播与反事实.md                                              | ChainError.lean         | 命题 2.1 的链式特例闭式                                                               |
...
| 02-误差传播与反事实.md                                              | LipschitzLayer.lean     | 命题 2.1 完整版 + 命题 2.5 完整式\|Xh_t − X_t\| ≤ ε_t + Σ_u ε_u·W u t、干预情形       |
...
| 00-假设与记号 / 01-样本复杂度 / 03-时空因果可见性 / 反事实与认知 01 | （待形式化）            |                                                                                       |
