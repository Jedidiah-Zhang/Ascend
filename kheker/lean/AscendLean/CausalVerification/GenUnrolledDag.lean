...
生成器：kheker/acceptance/gen_unrolled_dag.py
生成命令：.venv/bin/python kheker/acceptance/gen_unrolled_dag.py
巡检命令：.venv/bin/python kheker/acceptance/gen_unrolled_dag.py --check

来源：olam/ 的世界声明投影（export_world.py）
