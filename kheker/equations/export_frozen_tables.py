#!/usr/bin/env python3
"""生成预计算表数据模块（olam/kernel/frozen_tables.py）。
...
用法:
    .venv/bin/python kheker/equations/export_frozen_tables.py
"""
...
ROOT = HERE.parents[1]
OUT = ROOT / "olam" / "kernel" / "frozen_tables.py"
...
def build() -> str:
    ...
    lines = [
        '"""预计算表数据（生成物，禁止手改）。',
        "",
        "由 kheker/equations/export_frozen_tables.py 生成：",
