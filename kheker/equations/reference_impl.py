...
from olam.constants import ALPINE_ALTITUDE, DESERT_RAINFALL, LAPSE_RATE, OCEAN_COLD_CUTOFF, OCEAN_WARM_CUTOFF, POLAR_TEMP, RAINFOREST_RAINFALL, RAINFALL_MAX, RAINFALL_MIN, SEA_LEVEL_ELEV, STEPPE_MIN_TEMP, STEPPE_RAINFALL, TAIGA_RAINFALL, TEMPERATE_TEMP, TROPICAL_TEMP
