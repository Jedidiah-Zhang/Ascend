...
BACKEND = ROOT
DEFAULT_OUT = (
    BACKEND / "olam" / "declarations" / "impl_digests.json"
)

sys.path.insert(0, str(BACKEND))

from olam.meta.validate import (  # noqa: E402
    impl_key,
    kernel_source_digest,
    source_digest,
)
from olam.modules import clock, terrain, weather, worldgen  # noqa: E402
from olam.modules.weather import engine_inputs  # noqa: E402
...
def main() -> int:
    ...
    if args.check:
        ...
        if diff:
            print(diff)
        if not ok:
            print("修复: python kheker/equations/export_impl_digests.py")
