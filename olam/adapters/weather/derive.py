...
from olam.constants import HUMIDITY_TIER_BOUNDARIES, SUNLIGHT_INTENSITY_TIER_BOUNDARIES, SUNSHINE_TIER_BOUNDARIES, TEMP_TIER_BOUNDARIES, WIND_TIER_BOUNDARIES
