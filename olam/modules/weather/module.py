...
MODULE = ModulePack(
    ...
    parameters=(
        ...
        ParameterDecl(
            ...
            unit='tick',
            source='code-only:olam.constants.GAME_DAY（世界常量）',
            intervention_allowed=True,
        ),
        ParameterDecl(
        ...
        ParameterDecl(
            ...
            maximum=1000000000000.0,
            unit='tick',
            source='code-only:olam.constants.GAME_HOUR（世界常量）',
            intervention_allowed=True,
        ),
        ParameterDecl(
    ...
    evidence=('黄金向量对拍（testbench/world/test_weather_golden.py）',),
    notes='天气标量机制：时间派生、气候振幅、昼夜/季节偏移与瞬时读数。',
)
