...
注册的基线预测器评分，并计算相对基线臂的 CRN 配对效应。本模块只提供
可执行的骨架与报告形状。
"""
...
from olam.protocols.experiment import ExperimentSpec
from olam.protocols.oracle import Oracle
from olam.protocols.scoring import (
    paired_effects,
