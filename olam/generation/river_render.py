...
from olam.constants import RIVER_WIDTH_MIN, RIVER_WIDTH_MAX
from olam.generation.terrain import TerrainType
from olam.content.tile_grid import TileGrid, TILE_MAP_SIZE
from olam.generation.hydrology import river_width_log
...
def _render_streamlines(
    ...
    无需单位换算。
    """
    from olam.generation.streamlines import rivers_in_region
