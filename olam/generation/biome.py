...
from olam.constants import ALLUVIAL_BAND_M as _ALLUVIAL_BAND_M, ARID_RAINFALL_MM as _ARID_RAINFALL_MM, PERMAFROST_TEMP_C as _PERMAFROST_TEMP_C, SAND_BEACH_BAND_M as _SAND_BEACH_BAND_M
...
class BiomeTemplate:
    ...
    def __repr__(self) -> str:
        return (
            f"BiomeTemplate({self.biome_type.name}, "
            f"climate={self.climate_zone.name}, "
...
# 海平面海拔阈值 — 定义于 olam/constants.py
from olam.constants import SEA_LEVEL_ELEV as _SEA_LEVEL, OCEAN_COLD_CUTOFF as _OCEAN_COLD_CUTOFF, OCEAN_WARM_CUTOFF as _OCEAN_WARM_CUTOFF
