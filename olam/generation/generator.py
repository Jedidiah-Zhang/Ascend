...
from olam.generation.biome import BiomeType, biome_from_attrs
from olam.content.chunk import ChunkData

logger = logging.getLogger(__name__)

from olam.constants import NOISE_FREQ_DERIVED as _FREQ_DERIVED, MOISTURE_TILE_FREQUENCY as _MOISTURE_FREQ
...
class WorldGenerator:
    ...
    def generate_chunk(self, cx: int, cy: int) -> ChunkData:
        ...
        from olam.generation.climate import ClimateZone as _CZ
        climate = _CZ(zone)
