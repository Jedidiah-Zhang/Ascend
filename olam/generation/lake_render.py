...
用法:
    from olam.generation.lake_render import render_lake_chunk

    render_lake_chunk(tile_grid, world_x0, world_y0, lake_basins,
                      continent, seed)
"""

from olam.constants import LAKE_WETLAND_DEPTH_MAX
from olam.generation.randomness import cell_hash
