...
from olam.constants import TEXTURE_WAVELENGTH_TEMP, TEXTURE_WAVELENGTH_WIND, TEXTURE_WAVELENGTH_PRECIP, TEXTURE_OCTAVES, TEXTURE_PERSISTENCE, TEXTURE_LACUNARITY, TEXTURE_DRIFT_RATE
...
class TextureField:
    ...
    def __init__(
        ...
        *,
        ...
        # 派生经 olam.kernel 的地址随机——禁止裸 seed 偏移（见
