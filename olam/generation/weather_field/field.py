...
from olam.constants import WEATHER_FIELD_GRID_SIZE, WEATHER_FIELD_TILE_NOISE_WAVELENGTH, WEATHER_FIELD_TILE_NOISE_SCALE, TEMP_PERTURB_SCALE
from olam.kernel import Address, address_seed
from olam.generation.noise import PerlinNoise

from olam.generation.weather_field.atmosphere import (
...
class UnifiedWeatherField:
    ...
    def __init__(
        ...
        *,
        ...
        self._tile_noise = PerlinNoise(address_seed(
            seed, Address("weather", "tile_noise"),
        ))
