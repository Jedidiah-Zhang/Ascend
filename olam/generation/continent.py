...
from olam.generation.climate import ClimateZone, LAPSE_RATE
from olam.generation.randomness import seed_angle
from olam.constants import EROSION_ITERATIONS, LAKE_MIN_PIXELS, RIVER_FLOW_THRESHOLD, RIVER_MIN_LENGTH, RIVER_WIDTH_THRESHOLD, ELEVATION_TARGET_P99, ELEVATION_SCALE_FACTOR, CONTINENTALITY_K, CONTINENTALITY_D0_KM, RAINSHADOW_DECAY_KM, RAINSHADOW_SECONDARY_WEIGHT, RAINSHADOW_MIN_FACTOR, CONTINENT_BLEND_WEIGHT, CONTINENT_SAMPLE_RESOLUTION_M, TERRAIN_BLEND_WEIGHT, CENTER_BIAS_WEIGHT, CLIMATE_CALIB_RAINFALL_REF, CLIMATE_CALIB_TEMP_MIN, CLIMATE_CALIB_TEMP_MAX, CLIMATE_CALIB_HOT_THRESHOLD, CLIMATE_CALIB_COLD_RANGE, CLIMATE_CALIB_HOT_RAINFALL_TARGET, CLIMATE_CALIB_HOT_STRETCH_PARAM, CLIMATE_CALIB_COLD_RAINFALL_TARGET, CLIMATE_CALIB_COLD_STRETCH_PARAM
import logging

from olam.generation.continent_data import ContinentData, ContinentParams
...
class ContinentGenerator:
    ...
    def generate(
        ...
        from olam.generation.hydrology import erode, extract_lake_basins, HydrologyData
        ...
        from olam.generation.hydrology import compute_river_width
    ...
    def _calibrate_climate_merged(
        ...
        """
        from olam.generation.climate import classify
        n = w * h
    ...
    def _compute_subdiv_ranges(
        ...
        from olam.generation.biome import _SUBDIV_CONFIGS, _SUBDIV_MOISTURE
    ...
    def _compute_climate(
        ...
        # 气候计算（温度、降雨、气候分类）
        from olam.generation.hydrology import _compute_climate_c
