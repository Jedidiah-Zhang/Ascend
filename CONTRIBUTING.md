...
本节是工程文档结构与写作规范的维护入口，适用于[整体架构](docs/整体架构.md)及世界、智能体、游戏平台、研究平台四分区。研究理论保留原有组织和规范地位；归档只作历史参考。
