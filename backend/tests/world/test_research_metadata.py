...
from ascend.world.compile import CompileError
...
_SNAPSHOT = json.loads(
    (
        Path(__file__).parents[3] / "research" / "equations" / "equations.json"
