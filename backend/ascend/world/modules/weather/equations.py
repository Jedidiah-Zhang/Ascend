...
def _season_phase_cos_equation(
    ...
    """
    from ascend.world.kernel.fixed import round_half_even_div, to_float
    from ascend.world.kernel.frozen_tables import TABLE_BITS, TWO_PI_Q
    from ascend.world.kernel.tables import cos_q
...
def _solar_declination_equation(
    ...
    """
    from ascend.world.kernel.fixed import mul, quantize, round_half_even_div, to_float
    from ascend.world.kernel.frozen_tables import TABLE_BITS, TWO_PI_Q
    from ascend.world.kernel.tables import sin_q
...
def _sunrise_equation(latitude: float, solar_declination: float) -> float:
    ...
    """
    from ascend.world.kernel.fixed import (
        clamp as fixed_clamp, div, mul, quantize, round_half_even_div, to_float,
    )
    from ascend.world.kernel.frozen_tables import TABLE_BITS, TWO_PI_Q
    from ascend.world.kernel.tables import acos_q, degrees_q, tan_q
