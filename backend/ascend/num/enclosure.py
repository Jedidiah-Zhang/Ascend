...
其中 point 运算由 :mod:`ascend.num.fixed` 提供（半偶舍入），包含关系
由 ``tests/unit/test_num_enclosure.py`` 采样验证。定义域外/除零等未定义
...
def cos_enclosure(box: Interval) -> Interval:
    ...
    from .frozen_tables import PI_Q, TABLE_BITS, TWO_PI_Q
...
def sin_enclosure(box: Interval) -> Interval:
    ...
    from .frozen_tables import HALF_PI_Q, TABLE_BITS, TWO_PI_Q
    from .tables import DECLARED_EPSILON, sin_q
...
def tanh_enclosure(box: Interval) -> Interval:
    ...
    from .tables import TANH_MAX_ERROR, tanh_q
...
def acos_enclosure(box: Interval) -> Interval:
    ...
    from .frozen_tables import TABLE_BITS
    from .tables import ACOS_MAX_ERROR, acos_q
...
def tan_enclosure(box: Interval) -> Interval:
    ...
    from .frozen_tables import TABLE_BITS
    from .tables import TAN_MAX_ERROR
...
def degrees_enclosure(box: Interval) -> Interval:
    ...
    from .frozen_tables import TABLE_BITS
    from .tables import DEG_FACTOR_Q
